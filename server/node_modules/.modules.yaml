...
hoistedDependencies:
  ...
  jest-circus@29.7.0:
    jest-circus: private
  jest-cli@29.7.0(@types/node@22.13.0):
    jest-cli: private
  jest-config@29.7.0(@types/node@22.13.0):
    jest-config: private
  jest-diff@29.7.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Sun, 02 Feb 2025 05:49:06 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
virtualStoreDir: C:\Users\Admin\documents\mybti\server\node_modules\.pnpm
